...
<?php
    ...
    if(!isset($_GET['ucstory_id'])||$_GET['ucstory_id']==NULL){
        ?>
    ...
    if(isset($_GET['ucstory_id'])){
        $sql_query="SELECT * FROM posts WHERE post_id=".$_GET['ucstory_id'];
    ...
    {
        $del_query="SELECT * FROM posts WHERE post_id=".$_GET['ucstory_id'];
        ...
        {
            $sql_query = "UPDATE posts SET post_cover='$final_cover',post_date=NOW() WHERE post_id=".$_GET['ucstory_id'];
            if(mysqli_query($con,$sql_query))
            {
                ?>
                    <script type="text/javascript">
                        alert('Successfully updated the cover of your story!');
                            window.location.href='posts.php';
                    </script>
                <?php
            }
            else
            {
                ?>
                    <script type="text/javascript">
                        alert('Error occured while updating the cover of your story!');
                    </script>
                <?php
            }
        }
